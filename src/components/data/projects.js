const projects = [
    ...
    {
      title: "Portafolio",
      url: "https://stefaniadev.vercel.app/",
      git: "https://github.com/stefaniarosales/stefaniadev",
      description: "El objetivo era crear una página web limpia y estéticamente agradable, utilizando una paleta de colores reducida y tipografías sencillas. Durante el desarrollo, exploré diferentes técnicas de diseño responsivo, como media queries y flexbox. Este proyecto me permitió afianzar mis conocimientos en diseño de interfaces de usuario y mejorar mi capacidad para crear layouts flexibles y adaptables.",
      technologies: ["HTML","CSS","React","styled-components","Git"],
      image: 'https://res.cloudinary.com/dbotvxyzq/image/upload/v1743443948/stefaniaDev_yaoeg4.jpg',
    }
  ];
