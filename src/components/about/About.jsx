        ...
        <ContainerImgData>
          ...
          <ContentData>
            ...
            <ContainerSummary variants={itemVariants}>
              <Summary>Soy una Desarrolladora frontend con una sólida base en HTML, CSS, JavaScript y React, apasionada por crear interfaces de usuario intuitivas y visualmente atractivas.</Summary>
              <Summary>Busco mi primera oportunidad profesional para aplicar mis conocimientos y contribuir en proyectos innovadores. </Summary>
              <Summary>Me destaco por mi proactividad, habilidades de comunicación y capacidad para trabajar en equipo, con un enfoque constante en el aprendizaje y el crecimiento en entornos dinámicos y colaborativos.</Summary>
            </ContainerSummary>
          </ContentData>
        </ContainerImgData>
      </motion.div>
